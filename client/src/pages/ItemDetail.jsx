...
import { ArrowLeft, MapPin, Calendar, Tag, User, Clock, CheckCircle, Package } from 'lucide-react';
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="md:flex">
            ...
            <div className="md:w-1/2 p-6 md:p-8">
              {/* Status Badge */}
              <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${statusColors[item.status]} mb-4`}>
                ...
                isAuthenticated ? (
                  ...
                  <div>
                    ...
                    <p className="text-center text-sm text-gray-500 mt-2">
                      You need to be logged in to claim items
                    </p>
                  </div>
                )
              )}
