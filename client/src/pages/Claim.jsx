      ...
      <div className="min-h-[70vh] bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-2xl shadow-lg text-center max-w-md">
          ...
          <p className="text-gray-600 mb-4">
            We'll verify your claim and send pickup instructions to your email within 24 hours.
          </p>
          <div className="bg-navy-50 p-4 rounded-lg mb-4">
            <p className="text-sm text-navy-600">Reference Number</p>
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-md p-4 mb-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">📅 Found {new Date(item?.found_date).toLocaleDateString()}</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h1 className="text-2xl font-bold">Claim This Item</h1>
          </div>

          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <p className="text-yellow-800 text-sm">
              <strong>Important:</strong> To protect against theft, you must provide proof that this item belongs to you. 
...
- Specific scratches, dents, or wear marks
- Stickers, customizations, or engravings
- Contents (if it's a bag or wallet)
- Password/lock code (if applicable)
- Purchase date or receipt info"
              ...
              <p className="text-sm text-gray-500 mt-1">
                {formData.proofDescription.length}/20 characters minimum
              </p>
            </div>
            ...
            <p className="text-center text-sm text-gray-500">
              By submitting, you confirm this item belongs to you.
